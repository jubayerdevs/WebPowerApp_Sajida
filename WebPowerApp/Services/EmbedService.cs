...
namespace WebPowerApp.Services
{
    ...
    public static class EmbedService
    {
        ...
        public static async Task<PowerBIClient> GetPowerBiClient(string applicationId, string applicationSecret)
        {
            var tokenCredentials = new TokenCredentials(await AadService.GetAccessToken(applicationId, applicationSecret), "Bearer");
        ...
        public static async Task<ReportEmbedConfig> GetEmbedParams(Guid workspaceId, Guid reportId, string applicationId, string applicationSecret, [Optional] Guid additionalDatasetId)
        {

            using (var pbiClient = await GetPowerBiClient(applicationId, applicationSecret))
            {
                // Get report info
                ...
                var embedToken = await GetEmbedToken(reportId, applicationId, applicationSecret, datasetIds, workspaceId);
        ...
        public static async Task<ReportEmbedConfig> GetEmbedParams(Guid workspaceId, string applicationId, string applicationSecret, IList<Guid> reportIds, [Optional] IList<Guid> additionalDatasetIds)
        {
        ...
        public static async Task<EmbedToken> GetEmbedToken(Guid reportId, string applicationId, string applicationSecret, IList<Guid> datasetIds, [Optional] Guid targetWorkspaceId)
        {
            using (var pbiClient = await GetPowerBiClient(applicationId, applicationSecret))
            {
        ...
        public static async Task<EmbedToken> GetEmbedToken(IList<Guid> reportIds, IList<Guid> datasetIds, [Optional] Guid targetWorkspaceId)
        {
            ...
            using (var pbiClient = await GetPowerBiClient("23232","232323"))
            {
        ...
        public static async Task<EmbedToken> GetEmbedToken(IList<Guid> reportIds, IList<Guid> datasetIds, [Optional] IList<Guid> targetWorkspaceIds)
        {
            ...
            using (var pbiClient = await GetPowerBiClient("2323","332323"))
            {
        ...
        public static async Task<DashboardEmbedConfig> EmbedDashboard(Guid workspaceId)
        {
            ...
            using (var client = await GetPowerBiClient("2323","23232"))
            {
